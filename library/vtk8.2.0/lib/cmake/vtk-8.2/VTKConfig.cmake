...
set(_vtk_installed_prefix "D:/VTK/install/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "D:/VTK/install")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/VTK/install/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/VTK/install/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/VTK/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/VTK/build/lib")
  endif ()
endif()
